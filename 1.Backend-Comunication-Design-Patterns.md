...
This is a general term for techniques where the server sends updates to the client without waiting for a request. SSE and WebSockets are examples of push techniques.
